Class AI_RFTrooper_Omen : AI_Monster
{
		Default
		{
			...
			Dropitem "Hellstorm", 16,1;
			DropItem "PDW_Magazine", 32,2;
		...
		void FireProjBullets(bool AltAmmo)
		{
			...
			A_SpawnProjectile("e_arifle_tracer", 43, 2.5, frandom(-8,8), CMF_OFFSETPITCH , frandom(-8,8));
			AmmoInMag--;
		}
		...
		Reload:
			RFR1 A 6;
			RFR1 E 9 A_PlaySound("Weapons/StormMagOut");
			RFR1 E 16;
			RFR1 E 11 A_PlaySound("Weapons/DevMagOut");
			RFR1 E 6 A_PlaySound("Weapons/StormMagIn");
			RFR1 E 8 A_PlaySound("Weapons/StormMagLock");
			TNT1 A 0
			{
				AmmoInMag = 32;
			}
